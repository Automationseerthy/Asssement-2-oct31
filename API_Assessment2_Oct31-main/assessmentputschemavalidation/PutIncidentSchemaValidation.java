...
public class PutIncidentSchemaValidation extends RestAssuredBase {
	...
	public void put() {
    	Response response = RestAssured.given().contentType("application/json")
    			.header("Authorization","Bearer sjTohkhJERJZKfqy4TNfJwVlS6uTUb5ozvmVgjFguQ3iCQVbkJfelfumjm80renOu_r9HCUInR_0ZFqhZ6217g")
    			.when().body(("{\r\n"
    	    			+ "    \"short_description\": \"Updated via RA Seerthy\",\r\n"
    	    			+ "    \"description\": \"Description updated via RA Seerthy\"\r\n"
    	    			+ "}")).put("/incident/"+sys_id);
